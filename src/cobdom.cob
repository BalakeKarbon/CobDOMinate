...
009400     WS-END-DOUBLE-QUOTE DELIMITED BY SIZE
...
013400     WS-END-DOUBLE-QUOTE DELIMITED BY SIZE
...
014000   GOBACK.
014100*This will have to be done by wrapping scripts into a function
014200*with a try catch statement or something of the sort.
014300*COBDOM-INNER-HTML SECTION.
014400*ENTRY 'COBDOM-INNER-HTML' USING
014500*So here this gets crazy, since we are using eval, we can return
014600*the variable name, or we could store the objects in a structure
014700*and return its key/index, or we could create and add it relying
014800*only on the id.
