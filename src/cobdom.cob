...
010100   LS-FUNCTION.
010300   STRING
010300     PART-A OF STATUS-WRAPPER OF WS-JS-COMMANDS DELIMITED BY SIZE
010400     LS-ELEMENT-VARIABLE DELIMITED BY SPACE
010500     PART-A OF ADD-EVENT-LISTENER OF WS-JS-COMMANDS 
010600     DELIMITED BY SIZE
010700     LS-ELEMENT-TYPE DELIMITED BY SPACE
010800     PART-B OF ADD-EVENT-LISTENER OF WS-JS-COMMANDS 
010900     DELIMITED BY SIZE
011000     LS-FUNCTION DELIMITED BY WS-NULL-BYTE
011100     WS-END-PARENTHESIS DELIMITED BY SIZE
011200     PART-B OF STATUS-WRAPPER OF WS-JS-COMMANDS DELIMITED BY SIZE
011300     WS-NULL-BYTE DELIMITED BY SIZE
011400   INTO WS-JS-COMMAND END-STRING.
011500   CALL 'emscripten_run_script_int' USING BY REFERENCE 
011600     WS-JS-COMMAND RETURNING LS-RETURN.
011700   GOBACK.
011800*TO-DO put returns in these functions to verify success! This
011900*This will have to be done by wrapping scripts into a function
012000*with a try catch statement or something of the sort.
012100*COBDOM-INNER-HTML SECTION.
012200*ENTRY 'COBDOM-INNER-HTML' USING
012300*So here this gets crazy, since we are using eval, we can return
012400*the variable name, or we could store the objects in a structure
012500*and return its key/index, or we could create and add it relying
012600*only on the id.
