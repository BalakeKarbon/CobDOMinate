...
002400*  CALL 'emscripten_run_script' USING BY CONTENT WS-JS-TEST.
...
004400   CALL 'emscripten_run_script' USING BY REFERENCE WS-JS-COMMAND
004500     RETURNING LS-RETURN.
004600   GOBACK.
...
005900   CALL 'emscripten_run_script' USING BY REFERENCE WS-JS-COMMAND
006000     RETURNING LS-RETURN.
006100   GOBACK.
...
007400   CALL 'emscripten_run_script' USING BY REFERENCE WS-JS-COMMAND
007500     RETURNING LS-RETURN.
007600   GOBACK.
